...
# Install miscellaneous developer tools
sudo apt install -y make s3cmd postgresql-client-common postgresql-client
...
# Install latest LTS nvm and node
curl https://raw.githubusercontent.com/creationix/nvm/master/install.sh | bash
nvm install --lts
nvm use --lts

# Install terraform and terraform dependencies
